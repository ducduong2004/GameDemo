...
//			damagePlayer(attack);
	...
	public void draw(Graphics g2) {
		...
		if(inCamera()) {
			...
			switch(direction) {
			case "right": currentImage = frames[currentFrame];  break;
			case "left": currentImage = framesMirror[currentFrame]; break;
			case "up": currentImage = frames[currentFrame];  break;
			case "down" :currentImage = frames[currentFrame]; break;
			}
			animate();
			g2.drawImage(currentImage, screenX, screenY, null);
			g2.drawRect(screenX + solidArea.x, screenY + solidArea.x, 64, 64);
	...
	public void trashInBin(Entity entity) {
