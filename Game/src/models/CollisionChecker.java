...
public class CollisionChecker {
	...
	// check if player or an entity touching an object or not, if yes return the
	// index of the object in the Object array that contain all the object
	public int checkObject(Entity entity, boolean player) {
		...
		for (int i = 0; i < gp.obj.length; i++) {
			...
			if (obj != null) {
				...
				// !!!!! DO NOT CHANGE THIS, IT WILL CAUSE BUG WITH THE ENTITY AND OBJ SOLID
				// AREA VALUE
				// sau khi update xong thi set nguoc ve binh thuonwg
	...
	// check if entity contact to player or not
	...
	public boolean onBin(Entity entity) {
		...
		if (tileNum == gp.tileM.mapTileNum[gp.currentMap][entityCol][entityRow]) {
